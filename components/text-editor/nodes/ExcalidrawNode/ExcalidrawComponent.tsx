...
import { Expand, Pen, Shrink, Trash } from 'lucide-react-native';
...
export default function ExcalidrawComponent({
  ...
  const onResizeEnd = (
    ...
    editor.update(() => {
      ...
      if ($isExcalidrawNode(node)) {
        console.log("width:", node.getWidth())
          ...
          {isSelected && isEditable && (
            <div
              ...
              <div
                ...
                onMouseDown={(event) => event.preventDefault()}
                onClick={onResizeEnd}
              >{width == 200 ? <Expand size={20} />:<Shrink size={20} />}</div>
              <div
                className="image-edit-button"
                role="button"
                tabIndex={0}
